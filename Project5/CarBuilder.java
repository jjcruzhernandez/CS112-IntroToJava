...
public class CarBuilder {
	...
	//buildCarList method return a CarList of Car objects generated from the csv File.
		...
		try(Scanner input = new Scanner(inputFile)) {
			...
			while(input.hasNext()) {
				...
				if (fuelType.equals("Hydrogen") || fuelType.equals("Electricity")){
					...
					//add the greenCar to the newCarList
					...
					//add the gasCar to the newCarList
					newCarList.addCar(gasCar);
				}	
			}

		//if a FileNotFoundException is generated and returns null
